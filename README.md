...
OpenPrescription is free open-source software written in C++. Made for all bulgarian doctors and dentists out there, it is designed to be as user-friendly as possible.
